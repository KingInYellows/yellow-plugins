...
function collectCodexExposedFiles(rootDir, name, source) {
  ...
  if (existsSync(skillsDir)) {
    ...
    for (const entry of readdirSync(skillsDir, { withFileTypes: true })) {
      ...
      // here would lint content outside the generator-owned tree. lstat the
      // SKILL.md leaf and reject symlinks instead of following them.
      ...
      // them through the same DIRECT_CHECKS + registry-gated checks as
