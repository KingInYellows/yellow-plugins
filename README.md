...
| `yellow-core`         | Dev toolkit with review agents, research agents, and workflow commands for TS/Py/Rust/Go                    | 13 agents, 7 commands, 7 skills, 1 MCP         |
...
│   ├── yellow-core/           # Dev toolkit (13 agents, 7 commands, 7 skills, 1 MCP)
