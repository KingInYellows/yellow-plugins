...
This directory contains cross-platform Node.js automation scripts for the
yellow-plugins project. These scripts provide a consistent interface for common
development tasks.

## Scripts Overview

All scripts are written as CommonJS modules (`.cjs` extension) and are designed
to be:
...
**Purpose:** Ensures the development environment is properly configured and all
...
These scripts follow the **RuntimeScriptGenerator_v2.1** protocol and are
designed to:
