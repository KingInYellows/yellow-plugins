...
## Problem Statement
The `yellow-review/skills/pr-review-workflow/SKILL.md` file contains a shell code example at line 78 with unquoted variables in an awk command, violating the project convention that "Quote ALL variables in code examples."
...
- Project memory: "Shell Documentation Patterns - Quote ALL variables in code examples"
