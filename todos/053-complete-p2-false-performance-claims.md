...
README and command documentation make unsubstantiated performance claims that
don't match implementation reality:
...
**Why this matters**: Users will have incorrect expectations about performance.
Sets up plugin for negative reviews.
...
**Do both**: Optimize file enumeration (easy win), revise audit time claim (LLM
latency unavoidable).
...
- Optimized file enumeration: replaced `file --mime-type` with extension-based
  filtering (30-120s → 5-10s)
