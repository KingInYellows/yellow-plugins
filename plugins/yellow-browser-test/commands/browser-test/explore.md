...
```
Agent(subagent_type="yellow-browser-test:testing:test-runner"): "Run exploratory browser tests. Config at .claude/yellow-browser-test.local.md. Write results to test-reports/results.json. Test mode: exploratory. Starting route: {starting_route}."
```
