...
```
Agent(subagent_type="yellow-browser-test:testing:test-reporter"): "Generate report from test-reports/results.json. Write markdown report and offer GitHub issue creation for failures."
```
