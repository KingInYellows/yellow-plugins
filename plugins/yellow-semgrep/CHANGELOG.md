...
- [#716](https://github.com/KingInYellows/yellow-plugins/pull/716)
  ...
  Thanks [@KingInYellow18](https://github.com/KingInYellow18)! - `semgrep:fix`
  now resolves the active stacked-PR provider once via `stack-provider-router`
  before committing, instead of hardcoding Graphite. The Graphite path is
  unchanged.
