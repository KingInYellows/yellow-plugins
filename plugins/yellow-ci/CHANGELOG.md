...
- [#716](https://github.com/KingInYellows/yellow-plugins/pull/716)
  ...
  CLAUDE.md's PR-creation convention to point at the resolved active stacked-PR
...
- [#633](https://github.com/KingInYellows/yellow-plugins/pull/633)
  ...
  `/ci:setup-self-hosted` spawned the runner-assignment agent with a colon-less
  `subagent_type: "runner-assignment"`, which the Task runtime cannot resolve;
  now uses the fully-qualified `yellow-ci:ci:runner-assignment` form.
