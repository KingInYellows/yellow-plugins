...
| `user-invokable` instead of `user-invocable` (parsed SKILL.md frontmatter key only; prose, tables, changesets, and fenced examples are valid) | Parsed frontmatter key | P1 |
