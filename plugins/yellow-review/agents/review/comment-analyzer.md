...
- **P1**: Comment contradiction involves security-relevant behavior (auth, permissions, data access), correctness (would cause a bug if followed), or incorrect API usage (wrong parameter semantics). P2 for minor type mismatches or stale variable name references.
- **P2**: Comment is stale, incomplete, or missing for complex logic
- **P3**: Style issue, redundant comment, or minor improvement

## Instructions

**Pre-check:** Check for auto-generated file markers. If the file contains `Code generated by`, `DO NOT EDIT`, `@generated`, or `This file is auto-generated` at the top, skip comment accuracy checks for the entire file. Note: 'Skipping auto-generated file: <filename>.'
