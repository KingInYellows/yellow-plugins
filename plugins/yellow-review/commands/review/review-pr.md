...
| `agent-cli-readiness-reviewer` | `yellow-review:review:agent-cli-readiness-reviewer` | agent-cli-readiness | Diff touches `plugins/*/.claude-plugin/plugin.json`, `plugins/*/agents/**/*.md`, `plugins/*/commands/**/*.md`, `plugins/*/skills/**/SKILL.md`, or `plugins/*/hooks/` (7-principle severity-based audit: non-interactive defaults, structured output, actionable errors, safe retries, bounded output, composability, discoverability) |
