...
writing. The content may have changed during the user interaction in Step 4. Do
NOT rely on the content fetched in Step 3.

### Step 6: Confirm Changes (M3)

Present the proposed changes to the user. If the document content changed since
Step 3, highlight the differences. Ask user to confirm via AskUserQuestion
before applying.
...
- If document was deleted between Steps 3 and 5: report "Document no longer
  exists" and stop.
