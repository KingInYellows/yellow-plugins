...
symptom:
  ...
  'Unexpected indentation' on SKILL.md files"
root_cause:
...
4. **Update `create-agent-skills` SKILL.md** when attribute names change — it's
   the documentation source other plugin authors reference
5. **Add to MEMORY.md:** The correct spelling and format rule are now in project
   memory
