...
| `dismissed`  | Won't-fix or false positive, with actor and reason. **Suppresses re-raising** of the same fingerprint. |
...
| `reopened`   | A fixed or dismissed fingerprint reproduced again at a new head                                        |
