...
- scripts/validate-plugin.js: validatePathFile and validatePathOrPathsDir now use fs.lstatSync and reject symlinks outright (preventing arbitrary fs enumeration via symlink target).
