...
- New RULE 16 in `scripts/validate-agent-authoring.js` fails CI when any copy diverges, a declared file lacks the sentinel, or an undeclared plugins/ file carries one (containment)
