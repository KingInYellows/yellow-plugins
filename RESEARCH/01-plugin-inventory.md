...
| Public surface | Commands `/research:code`, `/research:deep`, `/research:setup`, `/flow:deepen-plan`. Agents `code-researcher`, `research-conductor`. Skill `research-patterns`. |
